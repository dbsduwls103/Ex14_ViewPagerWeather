package com.dbsduwls103.ex14_viewpagerweather.DailyPackage;
...
import com.dbsduwls103.ex14_viewpagerweather.DailyPackage.DailyData.DailyWeather;
import com.dbsduwls103.ex14_viewpagerweather.R;
import com.dbsduwls103.ex14_viewpagerweather.Utils.ApiService;
import com.dbsduwls103.ex14_viewpagerweather.Utils.SetRetrofit;
...
public class DailyFragment extends Fragment implements Callback<JsonObject> {
    ...
    private void initData() {
        ...
        call = SetRetrofit.retrofit().create(ApiService.class)
                .getDailyWeather(ApiService.APPID, lat, lon, ApiService.UNIT);
        call.enqueue(this);
    }
    ...
    public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
        if(response.isSuccessful()) {
            ...
            if(daily != null) {
                ...
                String tempStr = daily.getMain().getTemp() + "도 / ";
